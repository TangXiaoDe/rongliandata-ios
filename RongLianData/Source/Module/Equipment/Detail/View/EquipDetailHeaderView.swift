...
class EquipDetailHeaderView: UIView
{
...
extension EquipDetailHeaderView {

    class func loadXib() -> EquipDetailHeaderView? {
        return Bundle.main.loadNibNamed("EquipDetailHeaderView", owner: nil, options: nil)?.first as? EquipDetailHeaderView
    }
